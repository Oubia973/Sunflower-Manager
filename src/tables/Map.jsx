...
export default function MapTable() {
    ...
    if (mapSource.isleMap) {
        ...
        const BUILDING_OVERLAYS = {
            "crop machine": { src: imgstage1CollectorEmpty, w: 4, h: 5, top: "-50%" },
            greenhouse: { src: imggreenhouse, w: 4, h: 4, top: "-50%" },
        };
        const imgbeeIcon = <img src={imgbee} alt={''} title="Bee swarm" style={{ position: 'absolute', transform: 'translate(20%, -110%)', width: '14px', height: '14px' }} />;
        ...
        */
        ...
        adjustedIsleMap.forEach((row, x) => {
            Object.keys(row).forEach(y => {
                ...
                const isSwarm = item.swarm && imgbeeIcon;
