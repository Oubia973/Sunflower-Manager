...
function detectLeaderboardRewardKind(rows, auction) {
  ...
  if (hasSfl) return { kind: "sfl", label: "SFL", img: imgsfl };
          ...
          <h3 style={{ margin: 0, display: "inline-flex", alignItems: "center", gap: 8 }}>
            ...
            {cooldownLeftMs > 0 ? (
              <span style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 12, color: "#f8cc7b" }}>
                <img src={imgsyncing} alt="" className="itico" style={{ width: 14, height: 14 }} />
            ...
            <table className="table">
              <thead>
                <tr>
                  ...
                  {showUsdColumn ? (
                    <th className="thcenter">
                      <img src={imgusdc} alt="USDC" className="itico" style={{ width: 16, height: 16 }} />
                    </th>
                  ) : null}
