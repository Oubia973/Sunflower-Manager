    ...
    if (animalsData) {
        ...
        for (let key in AnimalsTable) {
            ...
            const tableContent = animalKeys.map((element, rowIndex) => {
                ...
                const honeyTreatImg = honeyTreatActive ? <img src={imghoneyTreat} alt={''} className="itico" title={"Honey Treat (-25% food)"} /> : null;
                const saltLickImg = saltLickActive ? <img src={imgsaltLick} alt={''} className="itico" title={"Salt Lick (+5% production)"} /> : null;
                ...
                return (
                    <tr key={`${itemName}-${cobj.id ?? cobj.lvl ?? rowIndex}-${rowIndex}`} style={{ ...cellStyle }}>
                        {/* <td id="iccolumn"></td> */}
                        ...
                        {xListeColAnimals[2][1] === 1 ? (
                            ...
                            >
                                ...
                                >
                                    {prod1 > 0 && formatAnimalProd(prod1)}{prod1 > 0 && prod1img}
                                </span>
                            </td>
                        ) : null}
                        {xListeColAnimals[3][1] === 1 ? <td className="tdcenter animal-prod2-sticky">{prod2 > 0 && formatAnimalProd(prod2)}{prod2 > 0 && prod2img}</td> : null}
                        {xListeColAnimals[4][1] === 1 ? <td className="tdcenter">{food}{foodimg}{honeyTreatImg}{saltLickImg}</td> : null}
            ...
            const tableHeader = (
                <thead>
                    <tr>
                        ...
                        {xListeColAnimals[5][1] === 1 ? <th className="thcenter">Cost {imgprodit}</th> : null}
                        {xListeColAnimals[6][1] === 1 ? <th className="thcenter">Bought {imgbuyit}</th> : null}
                        ...
                        {xListeColAnimals[8][1] === 1 ? <th className="thcenter" title="Prod cost per unit buying food at market">Bought {imgbuyit}</th> : null}
                        ...
                        {xListeColAnimals[10][1] === 1 ? <th className="thcenter" title="Prod cost per unit buying food at market">Bought {imgbuyit}</th> : null}
                    ...
                    <tr>
                        ...
                        {xListeColAnimals[2][1] === 1 ? <td className="tdcenter animal-prod1-sticky">{showTotal && formatAnimalProd(prod1Total)}</td> : null}
                        {xListeColAnimals[3][1] === 1 ? <td className="tdcenter animal-prod2-sticky">{showTotal && formatAnimalProd(prod2Total)}</td> : null}
