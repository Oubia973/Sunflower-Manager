...
export default function LavaPitsTable() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      >
        {renderMetricBadge("Existing Lava Pits", frmtNb(summary.existingPits, 0), imglavaPit, "Lava Pit")}
        {renderMetricBadge("Cycles per Pit / day", frmtNb(summary.pitCyclesPerDay), imgstopwatch, "Cycles")}
        {renderMetricBadge("Obsidian per Pit / day", frmtNb(summary.obsidianPerPitPerDay), imgobsidian, "Obsidian")}
      </div>
                ...
                <tr key={`${season.seasonKey}-${row.itemName}`}>
                  <td className="tditem">
                    <span style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
                      <img src={row.itemImg || imgna} alt="" className="itico" title={row.itemName} />
                      {row.itemName}
                    </span>
                  </td>
                  ...
                  <td className="tdcenter">
                    <span style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
                      <img src={row.nodeImg || imglightning} alt="" className="itico" title={row.nodeName} />
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
        ...
        >
          <img src={imglavaPit} alt="" className="itico" title="Lava Pit" />
                    ...
                    return (
                      ...
                      >
                        <span style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
                          ...
                          <img src={resource.itemImg || imgna} alt="" className="itico" title={resource.itemName} />
                        </span>
                      </td>
                    );
                  })}
