...
const NODE_PRICE_CONFIG = [
  { key: "Crop Plot", basePrice: 3, increase: 2, iconSrc: imgcrop },
  { key: "Fruit Patch", basePrice: 5, increase: 5, iconSrc: imgappleTree },
  { key: "Tree", basePrice: 4, increase: 3, iconSrc: imgwood },
  { key: "Stone Rock", basePrice: 4, increase: 3, iconSrc: imgstone },
  { key: "Iron Rock", basePrice: 7, increase: 5, iconSrc: imgironSmall },
  { key: "Gold Rock", basePrice: 10, increase: 6, iconSrc: imggoldSmall },
  { key: "Crimstone Rock", basePrice: 20, increase: 20, iconSrc: imgcrimstoneRock5 },
  { key: "Flower Bed", basePrice: 30, increase: 25, iconSrc: imgflowerbed },
  { key: "Oil Reserve", basePrice: 40, increase: 20, iconSrc: imgoil },
  { key: "Lava Pit", basePrice: 40, increase: 40, iconSrc: imglavaPit },
];
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(async () => {
      try {
        ...
        // Keep previous calculation data if the request is interrupted.
      } finally {
          ...
          <td className="tdcenter">
            {Number(obsidianPlan?.boughtObs || 0) > 0 ? (
              <span style={{ fontSize: "11px", opacity: 0.95, display: "inline-flex", alignItems: "center", gap: "2px" }}>
                {frmtNb(obsidianPlan.boughtObs)}<img src={imgobsidian} alt="" className="itico" title="Obsidian" />
                <span>&nbsp;/&nbsp;</span>
                {frmtNb(obsidianPlan.boughtPrice)}<img src={imgsfl} alt="" className="itico" title="Flower" />
              </span>
            ) : null}
          </td>
        ) : null}
        ...
        >
          <label style={{ display: "inline-flex", alignItems: "center", gap: "6px", fontSize: "12px", whiteSpace: "nowrap" }}>
            ...
            <span style={{ fontSize: "11px", opacity: 0.95, display: "inline-flex", alignItems: "center", gap: "2px" }}>
              ...
              <img src={imgsfl} alt="" className="itico" title="Flower" />
            </span>
          ...
          <tr ref={buyNodesHeaderRowRef}>
            ...
            {isColOn(1) ? <th className="thcenter">
              <span style={{ display: "inline-flex", flexDirection: "column", alignItems: "center", lineHeight: 1.05 }}>
                <span>Base</span>
                <img src={imgsunstone} alt="" className="itico" title="Sunstone" />
              </span>
            </th> : null}
            {isColOn(2) ? (
            ...
            {isColOn(9) ? (
              <th className="thcenter">
                <span style={{ display: "inline-flex", flexDirection: "column", alignItems: "center", lineHeight: 1.05 }}>
                  <span>Total</span>
                  <img src={imgobsidian} alt="" className="itico" title="Obsidian" />
                </span>
              </th>
            ) : null}
            {isColOn(10) ? (
              ...
              <th className="thcenter">
                <span style={{ display: "inline-flex", flexDirection: "column", lineHeight: 1.05 }}>
                  ...
                  <span style={{ fontSize: "10px", opacity: 0.9 }}>
                    Total <img src={imgobsidian} alt="" className="itico" title="Obsidian" /> / price
                  </span>
                </span>
              </th>
            ) : null}
            ...
            {(isColOn(11) && isWeekMode) ? (
              <td className="ttcenter">
                {Number(grandBoughtObsFromLines || 0) > 0 ? (
                  <span style={{ fontSize: "11px", opacity: 0.95, display: "inline-flex", alignItems: "center", gap: "2px" }}>
                    {frmtNb(grandBoughtObsFromLines)}<img src={imgobsidian} alt="" className="itico" title="Obsidian" />
                    <span>&nbsp;/&nbsp;</span>
                    {frmtNb(grandBoughtPriceFromLines)}<img src={imgsfl} alt="" className="itico" title="Flower" />
                  </span>
                ) : null}
              </td>
            ) : null}
