  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
      ...
      <div style={frameStyle}>
        ...
        />
        <button className="button" style={smallBtnStyle} onClick={saveProfile} title="Save profile">
          <img src={imgsave} alt="Save" style={iconStyle} />
        </button>
        {overLimit ? (
          <img
            src={imgrdy}
        ...
        <button className="button" style={smallBtnStyle} onClick={loadProfile} title="Load profile">
          <img src={imgconfirm} alt="Load" style={iconStyle} />
        </button>
        <button className="button" style={smallBtnStyle} onClick={removeProfile} title="Delete profile">
          <img src={imgcancel} alt="Delete" style={iconStyle} />
        </button>
      </div>
      ) : null}
      {showSummaryPanel ? (
      <div style={frameStyle}>
        <DList
          ...
          height={22}
        />
        <button className="button" style={smallBtnStyle} onClick={showSummary} title="Show summary">
          <img src={imgsearch} alt="Summary" style={iconStyle} />
        </button>
      </div>
      ) : null}
      {showSharePanel ? (
      <div style={frameStyle}>
        ...
        >
          <img src={imgcopy} alt="Copy" style={iconStyle} />
        </button>
        <input
          type="text"
          value={importText}
          ...
          style={{ width: 60, height: 18 }}
        />
        <button className="button" style={smallBtnStyle} onClick={importProfile} title="Import link as profile">
          <img src={imgimport} alt="Import" style={iconStyle} />
        </button>
      </div>
      ) : null}
