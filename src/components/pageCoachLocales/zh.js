const locale = {
  ...
  "featureSteps": [
    { "id": "features-graph", "title": "跟踪价格与供应量", "text": "图表可按资源和时间范围筛选，并同时显示价格变化和已售数量。", "image": "/pagecoach/features/graph.png", "imageAlt": "资源价格与成交量图表。" },
    { "id": "features-trynft", "title": "测试增益与收藏品", "text": "Tryset 将当前农场与测试配置进行比较，显示其对产量、收获和每日收益的影响。", "image": "/pagecoach/features/trynft.png", "imageAlt": "包含产量和收藏品的 Tryset 模拟。" },
