const locale = {
  ...
  "featureSteps": [
    { "id": "features-graph", "title": "価格と供給量を追跡", "text": "グラフでは資源と期間を選択し、価格の推移と販売量をあわせて確認できます。", "image": "/pagecoach/features/graph.png", "imageAlt": "資源の価格と販売量のグラフ。" },
    { "id": "features-trynft", "title": "ブーストとコレクティブルを試す", "text": "Tryset は現在の農場とテスト構成を比較し、収量、収穫量、日次収益への影響を表示します。", "image": "/pagecoach/features/trynft.png", "imageAlt": "収量とコレクティブルを含む Tryset シミュレーション。" },
