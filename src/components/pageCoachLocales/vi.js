const locale = {
  ...
  "featureSteps": [
    { "id": "features-graph", "title": "Theo dõi giá và nguồn cung", "text": "Biểu đồ cho phép chọn tài nguyên và khoảng thời gian, rồi hiển thị biến động giá cùng khối lượng đã bán.", "image": "/pagecoach/features/graph.png", "imageAlt": "Biểu đồ giá và khối lượng của tài nguyên." },
    { "id": "features-trynft", "title": "Thử boost và vật phẩm sưu tầm", "text": "Tryset so sánh nông trại đang hoạt động với cấu hình thử nghiệm để cho thấy tác động lên sản lượng, thu hoạch và lợi nhuận mỗi ngày.", "image": "/pagecoach/features/trynft.png", "imageAlt": "Mô phỏng Tryset với sản lượng và vật phẩm sưu tầm." },
    { "id": "features-chores", "title": "Lập kế hoạch chores và bounties", "text": "Deliveries Chores Bounties theo dõi tiến độ, phần thưởng, nguyên liệu còn thiếu, chi phí và thời gian còn lại.", "image": "/pagecoach/features/chores.png", "imageAlt": "Danh sách chores với tiến độ và nguyên liệu cần thiết." },
    { "id": "features-cooktolvl", "title": "Tối ưu tiến trình XP", "text": "Cook dự tính công thức để đạt cấp mục tiêu và so sánh XP, thời gian, dầu, chi phí cùng việc mua trên market.", "image": "/pagecoach/features/cooktolvl.png", "imageAlt": "Bảng Cook để đạt cấp mục tiêu." },
    { "id": "features-listings", "title": "So sánh listing với giá floor", "text": "Listings hiển thị số lượng, giá, floor, chênh lệch và ngày để nhanh chóng nhận ra đề nghị hấp dẫn.", "image": "/pagecoach/features/listings.png", "imageAlt": "Listing được so sánh với giá floor." },
    { "id": "features-trades", "title": "Phân tích giao dịch - Supporter", "text": "Tính năng Supporter khả dụng sau khi đóng góp: Activity hiển thị vật phẩm đã bán, giá trung bình và lịch sử dạng biểu đồ.", "image": "/pagecoach/features/trades.png", "imageAlt": "Chế độ Supporter Activity cho giao dịch và biểu đồ bán hàng." },
    { "id": "features-activitydelivery", "title": "Đo chi phí deliveries - Supporter", "text": "Tính năng Supporter khả dụng sau khi đóng góp: Activity báo cáo deliveries đã hoàn thành, tài nguyên đã dùng và chi phí trong một khoảng thời gian.", "image": "/pagecoach/features/activitydelivery.png", "imageAlt": "Lịch sử Supporter Activity của deliveries theo ngày." }
  ],
  "baseSteps": [
    {
      "id": "options",
