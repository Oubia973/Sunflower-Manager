const locale = {
  ...
  "featureSteps": [
    ...
    { "id": "features-trades", "title": "Phân tích giao dịch - VIP", "text": "Tính năng VIP khả dụng sau khi đóng góp: Activity hiển thị vật phẩm đã bán, giá trung bình và lịch sử dạng biểu đồ.", "image": "/pagecoach/features/trades.png", "imageAlt": "Chế độ VIP Activity cho giao dịch và biểu đồ bán hàng." },
    { "id": "features-activitydelivery", "title": "Đo chi phí deliveries - VIP", "text": "Tính năng VIP khả dụng sau khi đóng góp: Activity báo cáo deliveries đã hoàn thành, tài nguyên đã dùng và chi phí trong một khoảng thời gian.", "image": "/pagecoach/features/activitydelivery.png", "imageAlt": "Lịch sử VIP Activity của deliveries theo ngày." }
  ],
  "baseSteps": [
    {
      "id": "options",
