const locale = {
  ...
  "featureSteps": [
    ...
    { "id": "features-trades", "title": "Analisis trades - VIP", "text": "Fitur VIP tersedia setelah kontribusi: Activity menampilkan barang terjual, harga rata-rata, dan riwayat dalam grafik.", "image": "/pagecoach/features/trades.png", "imageAlt": "Tampilan VIP trades dan grafik penjualan." },
    { "id": "features-activitydelivery", "title": "Ukur biaya deliveries - VIP", "text": "Fitur VIP tersedia setelah kontribusi: Activity melaporkan deliveries yang selesai, sumber daya yang dipakai, dan biayanya selama suatu periode.", "image": "/pagecoach/features/activitydelivery.png", "imageAlt": "Riwayat VIP deliveries harian." }
  ],
  "baseSteps": [
    {
      "id": "options",
