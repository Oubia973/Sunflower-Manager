const locale = {
  ...
  "featureSteps": [
    { "id": "features-graph", "title": "Pantau harga dan pasokan", "text": "Grafik memungkinkan Anda memilih sumber daya dan periode, lalu melihat perubahan harga beserta volume yang terjual.", "image": "/pagecoach/features/graph.png", "imageAlt": "Grafik harga dan volume sumber daya." },
    { "id": "features-trynft", "title": "Uji boost dan collectible", "text": "Tryset membandingkan pertanian aktif dengan konfigurasi uji untuk menunjukkan dampaknya pada hasil panen dan keuntungan harian.", "image": "/pagecoach/features/trynft.png", "imageAlt": "Simulasi Tryset dengan hasil dan collectible." },
    { "id": "features-chores", "title": "Rencanakan chores dan bounties", "text": "Deliveries Chores Bounties melacak progres, hadiah, komponen yang kurang, biaya, dan waktu tersisa.", "image": "/pagecoach/features/chores.png", "imageAlt": "Daftar chores dengan progres dan komponen yang diperlukan." },
    { "id": "features-cooktolvl", "title": "Optimalkan progres XP", "text": "Cook memproyeksikan resep untuk mencapai level target dan membandingkan XP, waktu, minyak, biaya, serta pembelian market.", "image": "/pagecoach/features/cooktolvl.png", "imageAlt": "Tabel Cook untuk mencapai level target." },
    { "id": "features-listings", "title": "Bandingkan listing dengan floor", "text": "Listing menampilkan jumlah, harga, floor, selisih, dan tanggal agar penawaran menarik cepat terlihat.", "image": "/pagecoach/features/listings.png", "imageAlt": "Listing dibandingkan dengan harga floor." },
    { "id": "features-trades", "title": "Analisis trades - Supporter", "text": "Fitur Supporter tersedia setelah kontribusi: Activity menampilkan barang terjual, harga rata-rata, dan riwayat dalam grafik.", "image": "/pagecoach/features/trades.png", "imageAlt": "Tampilan Supporter trades dan grafik penjualan." },
    { "id": "features-activitydelivery", "title": "Ukur biaya deliveries - Supporter", "text": "Fitur Supporter tersedia setelah kontribusi: Activity melaporkan deliveries yang selesai, sumber daya yang dipakai, dan biayanya selama suatu periode.", "image": "/pagecoach/features/activitydelivery.png", "imageAlt": "Riwayat Supporter deliveries harian." }
  ],
  "baseSteps": [
    {
      "id": "options",
